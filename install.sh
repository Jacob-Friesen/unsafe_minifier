...
printf "\n"
printf "${blue}Installation is now complete. Since this bash script invokes some changes in a seperate context, make sure you are using Node.js v0.8.2 (node -v to check)\n"
printf "\n${reset}"
